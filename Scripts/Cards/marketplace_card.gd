...
var sprites = [
	"Assets/Card Patterns/Marketplace/marketplace1.PNG", 
	"Assets/Card Patterns/Marketplace/marketplace2.PNG", 
	"Assets/Card Patterns/Marketplace/marketplace3.PNG", 
	"Assets/Card Patterns/Marketplace/marketplace4.PNG", 
	]
