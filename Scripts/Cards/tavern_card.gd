...
var sprites = [
	"Assets/Card Patterns/Tavern/tavern1.PNG", 
	"Assets/Card Patterns/Tavern/tavern2.PNG", 
	"Assets/Card Patterns/Tavern/tavern3.PNG", 
	"Assets/Card Patterns/Tavern/tavern4.PNG", 
	]
