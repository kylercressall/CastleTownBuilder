...
var sprites = [
	"Assets/Card Patterns/Cottage/cottage1.PNG", 
	"Assets/Card Patterns/Cottage/cottage2.PNG",
	"Assets/Card Patterns/Cottage/cottage4.PNG",
	"Assets/Card Patterns/Cottage/cottage3.PNG"
	]
