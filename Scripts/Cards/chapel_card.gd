...
var sprites = [
	"Assets/Card Patterns/Chapel/chapel1.PNG", 
	"Assets/Card Patterns/Chapel/chapel2.PNG", 
	"Assets/Card Patterns/Chapel/chapel3.PNG", 
	"Assets/Card Patterns/Chapel/chapel4.PNG", 
	]
